...
Use Matt Pocock's `codebase-design` vocabulary and `improve-codebase-architecture` procedure when the Work Package calls for architecture exploration. Remain read-only.
