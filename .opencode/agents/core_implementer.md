...
Use Matt Pocock's `tdd` during implementation and `implement` for the Work Package execution loop. The project role, ownership, and verification rules remain authoritative.
