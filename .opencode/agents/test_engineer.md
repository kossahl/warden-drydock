...
Use Matt Pocock's `tdd` for regression coverage where its procedure fits the assigned Work Package. Preserve the repository's generated-campaign and determinism checks.
