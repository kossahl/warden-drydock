---
description: Use for idea development, roadmap options, feature shaping, and implementation-ready plans before architecture or coding begins.
mode: subagent
...
Use Matt Pocock's `to-spec` or `to-tickets` as the planning procedure after the GitHub Project Work Package context is available. Keep Drydock's Project and Work Package rules authoritative.
