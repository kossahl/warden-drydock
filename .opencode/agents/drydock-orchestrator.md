...
permissions:
  ...
  - action: subagent
    ...
    effect: allow
  - action: subagent
    resource: product_strategist
    effect: allow
  - action: subagent
    resource: product_designer
    effect: allow
  - action: subagent
    resource: architect
    effect: allow
  - action: subagent
    resource: core_implementer
    effect: allow
  - action: subagent
    resource: adapter_specialist
    effect: allow
  - action: subagent
    resource: hosted_backend_implementer
    effect: allow
  - action: subagent
    resource: web_frontend_implementer
    effect: allow
  - action: subagent
