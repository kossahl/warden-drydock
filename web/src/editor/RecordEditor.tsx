...
const editorProposalLocation = (proposal: EditorProposal | null) => editorProposalVersionLocation(proposal?.proposal_id ?? null, proposal?.proposal_version ?? null);
